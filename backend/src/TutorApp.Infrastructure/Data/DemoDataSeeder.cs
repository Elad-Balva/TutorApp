...
public static class DemoDataSeeder
{
    ...
    public static async Task SeedIfEmptyAsync(AppDbContext db, ILogger logger, CancellationToken ct = default)
    {
        ...
        {
            logger.LogInformation("Demo seed skipped: students already exist.");
            return;
        }
        ...
        logger.LogInformation("Demo seed completed: {Count} students, lessons and sample payments.", students.Length);
    }
}
